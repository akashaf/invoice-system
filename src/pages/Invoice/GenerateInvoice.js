...
const GenerateInvoice = (props) => {
    ...
    const totalItem = () => {
        let total = 0;
        if (invoiceItemDetailData && invoiceItemDetailData.length > 0) {
                            ...
                            <Grid container spacing={2}>
                                ...
                                <Grid item xs>
                                    <Box style={{ textAlign: 'right' }}>
                                        ...
                                        <Typography gutterBottom>{invoiceItemDetailData.lotno}</Typography>
                                        <Typography><b>Build up</b></Typography>
                                        <Typography gutterBottom>{invoiceItemDetailData.buildup}</Typography>
